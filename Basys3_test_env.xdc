...
set_property PACKAGE_PIN T18 [get_ports {BtnJump}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {BtnJump}]
...
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {SDIN}];#Sch name = JB2
#set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports {SCLK}];#Sch name = JB3
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {SCLK}];#Sch name = JB4
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports {DC}];#Sch name = JB7
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports {RES}];#Sch name = JB8
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports {VBAT}];#Sch name = JB9
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports {VDD}];#Sch name = JB10
